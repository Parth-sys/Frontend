...
<footer className="text-center text-lg-start bg-white text-muted">
      ...
      <div className="row mt-3">
        ...
        <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 className="text-uppercase fw-bold mb-4">
            <i className="fas fa-gem me-3 text-grayish"></i>ECOMM 
          </h6>
          <p>
             Here you can  shop ur favourite Cloths.
             There are Categories of Cloths available for Men and Woman.
              enjoy Shopping...
          </p>
        </div>
        ...
        <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" className="text-reset bordernone">Joggers</a>
          </p>
          <p>
            <a href="#!" className="text-reset bordernone">T-shirts</a>
          </p>
        </div>
        ...
        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" className="text-reset bordernone">Locations</a>
          </p>
          <p>
            <a href="#!" className="text-reset bordernone">Shops</a>
          </p>
          <p>
            <a href="#!" className="text-reset bordernone">Offers</a>
          </p>
          <p>
  ...
  <div className="text-center p-4" style={{backgroundColor:"rgba(0, 0, 0, 0.025)"}}>
    © 2022 Copyright:
    <a className="text-reset fw-bold" href="/">Ecom.com</a>
  </div>
